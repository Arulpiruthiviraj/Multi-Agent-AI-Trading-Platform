...
CREATE TABLE `__new_memory_rules` (
	...
	`created_at` integer DEFAULT 1786382790774
);
--> statement-breakpoint
...
CREATE TABLE `__new_sessions` (
	...
	`created_at` integer DEFAULT 1786382790772
);
--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_settings`("id", "trading_mode", "risk_level", "selected_broker", "selected_ai_provider", "budget", "strategy", "max_trade_size", "daily_loss_limit", "take_profit_pct", "trailing_stop_pct", "min_ai_confidence", "auto_bot_enabled", "adversarial_debate_mode", "onboarding_complete", "created_at") SELECT "id", "trading_mode", "risk_level", "selected_broker", "selected_ai_provider", "budget", "strategy", "max_trade_size", "daily_loss_limit", "take_profit_pct", "trailing_stop_pct", "min_ai_confidence", "auto_bot_enabled", "adversarial_debate_mode", "onboarding_complete", "created_at" FROM `settings`;--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`email` text NOT NULL,
	`password_hash` text,
	`created_at` integer DEFAULT 1786382790771
);
--> statement-breakpoint
