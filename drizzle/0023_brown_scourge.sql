...
CREATE TABLE `__new_memory_rules` (
	...
	`created_at` integer DEFAULT 1786582860901
);
...
CREATE TABLE `__new_sessions` (
	...
	`created_at` integer DEFAULT 1786582860897
);
--> statement-breakpoint
...
CREATE TABLE `__new_settings` (
	...
	`created_at` integer DEFAULT 1786582860898,
...
CREATE TABLE `__new_users` (
	...
	`email` text NOT NULL,
	`password_hash` text,
	`created_at` integer DEFAULT 1786582860896
);
--> statement-breakpoint
...
ALTER TABLE `quant_strategy_backtests` ADD `benchmark_comparison` text;