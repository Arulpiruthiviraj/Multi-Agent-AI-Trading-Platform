...
CREATE TABLE `__new_memory_rules` (
	...
	`created_at` integer DEFAULT 1786446898356
);
...
CREATE TABLE `__new_sessions` (
	...
	`created_at` integer DEFAULT 1786446898354
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`email` text NOT NULL,
	`password_hash` text,
	`created_at` integer DEFAULT 1786446898353
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX `idx_trades_trace_id_unique` ON `trades` (`trace_id`);