...
const updatedIntelligenceUI = `
          <div className="animate-fade-in flex flex-col gap-6" id="intelligence-view">
            <div className="bg-[#1A1F2B] border border-slate-800 rounded-lg p-5">
              ...
              <div className="mt-6 bg-[#1A1F2B] border border-slate-800 rounded-lg p-5">
...
const startIndex = code.indexOf('<div className="animate-fade-in flex flex-col gap-6" id="intelligence-view">');
const endIndexStr = `        {activeTab === "agents" && (() => {`;
