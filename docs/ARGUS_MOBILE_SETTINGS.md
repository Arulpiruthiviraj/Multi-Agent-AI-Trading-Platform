...
| Max watchlist | `maxActiveSubscriptions` | **12** (Alpaca default; 90 under `ibkr_gateway`). Alpaca IEX bounded feed; worker prunes least-active non-protected symbols at the cap. |
