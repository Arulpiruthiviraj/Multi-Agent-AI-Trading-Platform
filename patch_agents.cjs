...
fs.writeFileSync('src/server/services/FundamentalAgent.ts', fundamentalCode);
fs.writeFileSync('src/server/services/MacroAgent.ts', macroCode);
console.log("Patched FundamentalAgent and MacroAgent");
